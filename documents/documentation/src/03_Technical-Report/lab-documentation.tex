...
This Introduction is used to explain the basic functionalities of the tools used to solve the future labs. In this case GDB (GNU Debugger), x64dbg and IDA Freeware.
\subsubsection*{Choice of Topic}
The solutions and tipps in the labs are given via screenshots or explanations using either GDB, x64dbg or IDA Freeware. If a student wants to use a different tool he / she is free to do so. It is important that the tools used in the example solutions are known to the students. This makes it easier for them to understand each step and, if they are stuck at any point, follow the intructions on how to solve it. 
\subsubsection*{Objectives}
\begin{itemize}
    \item Learn about GDB and how to use the different commands availabale
    \item Learn about x64dbg and how to navigate it
    \item Learn about IDA Freeware and how to navigate it
\end{itemize}
