...
The lab titles and content changed over the time of the project and the final scope of the labs differs from the one at the beginning. The \ref{sec:task} defined that ASLR and DEP should be a part of the labs but after thorough discussions between the advisor and the students the final topics were selected and DEP was decided to be a project for the follow up work. The final list is shown in table \ref{tab:labs}. 
