...
For time tracking the team has decided on using a third party application named Clockify. To have an overview on what the team spents its time on we decided to create different tags: 
\begin{itemize}
